...
const BannerManagement = () => {
    ...
    const handleSaveBanners = async () => {
        ...
        try {
            ...
            if (savedBanners.desktop) {
                ...
                formData.append(
                    "desktopMediaType",
                    savedBanners.desktop.type.startsWith("video/")
                        ? "video"
                        : "image"
                );
            }
    ...
    const handleSaveMobileBanners = async () => {
        ...
        try {
            ...
            if (savedBanners.mobile) {
                ...
                formData.append(
                    "mobileMediaType",
                    savedBanners.mobile.type.startsWith("video/")
                        ? "video"
                        : "image"
                );
            }
    ...
    const handleResetBanners = () => {
        if (window.confirm('Are you sure you want to reset all banners for this section?')) {
            setDesktopPreview(null);
            setMobilePreview(null);
        }
    };
                ...
                <div className="p-6 border-b border-gray-200">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="w-full sm:flex-1">
                            <h2 className="text-xl font-bold text-gray-900">Upload Banner Images / Video for {currentSection.name}</h2>
                        </div>
                ...
                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-gray-50 rounded-xl border border-gray-200 p-5">
                            ...
                            {/* Upload Area */}
                            <div className={`border-2 border-dashed rounded-xl p-2 transition-colors
                  ${desktopPreview ? 'border-green-200 bg-green-50' : 'border-gray-300 hover:border-blue-400 bg-white'}`}
                            >
                                {desktopPreview ? (
                        ...
                        <div className="bg-gray-50 rounded-xl border border-gray-200 p-5">
                            ...
                            <div className={`border-2 border-dashed rounded-xl p-2 transition-colors
                                            ${mobilePreview ? 'border-green-200 bg-green-50' : 'border-gray-300 hover:border-blue-400 bg-white'}`}
                            >
                                {mobilePreview ? (
                                    <div className="space-y-4">
                                        <div className="relative rounded-lg overflow-hidden bg-gray-100 shadow-sm">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                    ...
                    <div>
                        <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                            <thead className="bg-gray-100 sticky top-0 z-10">
                                <tr>
                                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">       Desktop Banner                                   </th>
                                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">   Media Type                                    </th>
                                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">  Action                                    </th>
                                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">  Select Media                                    </th>
                                </tr>
                            </thead>
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button
                                                        onClick={() => handleDeleteDesktopBanner(banner?._id, "desktop")}
                    ...
                    <div>
                        <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
                            <thead className="bg-gray-100 sticky top-0 z-10">
                                <tr>
                                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">Mobile Banner</th>
                                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">     Media Type       </th>
                                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">                  Action                                    </th>
                                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">  Select Media                                    </th>
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button
                                                        onClick={() => handleDeleteMobileBanner(banner?._id)}
                                                        className="p-2 text-red-600 hover:bg-red-50 rounded-lg cursor-pointer"
                                                        title="Delete"
                                                    >
                                                        <Trash2 className="w-4 h-4" />
