...
const ContentManagement = () => {
  ...
  const confirmDeleteContent = async (page, closeToast) => {
    ...
    try {
      // await axios.delete(
      //   `http://localhost:3000/api/generalContent/delete-content?page=${page}`,
      // );
      await axios.delete(
        `https://ba-dastoor-backend.onrender.com/api/generalContent/delete-content?page=${page}`,
      );
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
            ...
            <div className="mt-8 space-y-4">
              ...
              <h3 className="text-2xl font-bold text-gray-900">
                {generalContent.secondaryHeading || "Null"}
              </h3>

              <p className="text-gray-700 leading-relaxed">
                {generalContent.secondaryDescription || "Null"}
              </p>
              {/* {generalContent?.media?.url &&
                (generalContent.media.mediaType === "image" ? (
                  <img
